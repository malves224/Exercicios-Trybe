...
const Calculate = __importStar(require("./calculosDeArea"));
...
console.log(`Circulo com um raio de 5${Calculate.calculateCircle(5)}`);
console.log(`Losango ${Calculate.calculateDiamond(7, 5)}`);
console.log(`trapaze ${Calculate.calculateTrapeze(5, 3, 7)}`);
