...
const validationsBook_1 = __importDefault(require("../middlewares/validationsBook"));
...
router.post("/books", validationsBook_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const book = req.body;
    const books = yield (0, functions_1.read)();
    books.push(book);
...
router.put("/books/:isbn", validationsBook_1.default, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { isbn } = req.params;
